...
class Nodes::NameCapitalizer
  PEOPLE_NAMES = %w[Greg Paul John Pete Jan Troy Lucy Marc Sep Mark Kate Sam Hugh Ann Anne Ross Ian Kain Anna Zoe Luke Holt Zali Ryan Gai Lee Jane Dyer Tony].freeze
